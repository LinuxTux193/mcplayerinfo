...
function get_langs(sus) {
    fetch("/lang/list.json").then(res => { return res.json() }).then(json => { return resolve(json) })
}

function get_lang(lang) {
    fetch("/lang/" + lang + ".json").then(res => { return res.json() }).then(json => { return json})
}
console.log(get_langs('sus'))
...
get_langs().then(function(all_langs) {
...
get_lang(language).then(function(language) { 
